...
print(f"You have {filesNo} OPENMETEO files")
...
#print(allDataDiff)
allData.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_OPEN-METEO.pkl')
allDataDiff.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_diff_OPEN-METEO.pkl')
