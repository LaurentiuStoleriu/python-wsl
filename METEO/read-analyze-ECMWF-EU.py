...
print(f"You have {filesNo} ECMWF files")
...
#print(allDataDiff)
allData.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_ECMWFEU.pkl')
allDataDiff.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_diff_ECMWFEU.pkl')
