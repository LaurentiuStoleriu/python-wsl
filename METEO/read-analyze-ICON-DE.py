...
print(f"You have {filesNo} GEMCanada files")
...
#print(allDataDiff)
allData.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_ICONGermany.pkl')
allDataDiff.to_pickle('/home/lali/TITAN-ROG-sync/python/METEO/Rez_diff_ICONGermany.pkl')
